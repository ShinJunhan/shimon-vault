...
# ── Prometheus (on-prem monitoring, stable Tailscale IP) ──────────────────────
# proj-mgmt's Tailscale IP is stable (same pattern as REPLICA_HOST above).
# The admin console fetches infra metrics from here over the mesh.
PROMETHEUS_HOST="100.106.194.10"
PROMETHEUS_PORT="9090"
PROMETHEUS_URL="http://${PROMETHEUS_HOST}:${PROMETHEUS_PORT}"

# ── Demo console (static settings) ────────────────────────────────────────────
...
# ── Prometheus (on-prem, via Tailscale) ──────────────────────
PROMETHEUS_URL=${PROMETHEUS_URL}

# ── Demo console ─────────────────────────────────────────────
DEMO_ENABLED=${DEMO_ENABLED}
DEMO_BASE_URL=${DEMO_BASE_URL}
DEMO_ATTACKER_IP=${DEMO_ATTACKER_IP}
DEMO_LOGIN_ATTEMPTS=${DEMO_LOGIN_ATTEMPTS}
